...
"""This package contains round behaviours of VeraChainedSkillAbciApp."""

import packages.dvilela.skills.vera_abci.rounds as VeraAbci
...
abci_app_transition_mapping: AbciAppTransitionMapping = {
    RegistrationAbci.FinishedRegistrationRound: VeraAbci.UpdateNewsPoolRound,
    VeraAbci.FinishedPublishRound: ResetAndPauseAbci.ResetAndPauseRound,
    ResetAndPauseAbci.FinishedResetAndPauseRound: VeraAbci.UpdateNewsPoolRound,
...
VeraChainedSkillAbciApp = chain(
    (
        RegistrationAbci.AgentRegistrationAbciApp,
        VeraAbci.VeraAbciApp,

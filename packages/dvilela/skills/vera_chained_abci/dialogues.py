...
from packages.dvilela.skills.vera_abci.dialogues import (
    KvStoreDialogue as BaseKvStoreDialogue,
)
from packages.dvilela.skills.vera_abci.dialogues import (
    KvStoreDialogues as BaseKvStoreDialogues,
)
from packages.dvilela.skills.vera_abci.dialogues import SrrDialogue as BaseSrrDialogue
from packages.dvilela.skills.vera_abci.dialogues import SrrDialogues as BaseSrrDialogues
